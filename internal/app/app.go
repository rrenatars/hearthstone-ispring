...
func Run() {
	...
	pl1 := models.NewPlayer("name", tools.GetRandomElementsFromDeck(&deck, 3), deck, []models.CardData{}, []models.CardData{}, true, 30, 100, 0, 0, "")
	pl2 := models.NewPlayer("name", tools.GetRandomElementsFromDeck(&deck, 3), deck, []models.CardData{}, []models.CardData{}, false, 30, 100, 0, 0, "")
